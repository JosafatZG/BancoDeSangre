      ...
      <View style= {styles.contenedorBuscador}>
			...
			<ScrollView>
				<View style = {styles.cartaPaciente}>
					...
					>
						<View style = {styles.contenedorContenido}>
							<Text style = {styles.informacion}>Paciente: Claudia Lopez</Text>
				...
				<View style = {styles.cartaPaciente}>
					...
					>
						<View style = {styles.contenedorContenido}>
							<Text style = {styles.informacion}>Paciente: Francisco Mendez</Text>
							<Text style = {styles.informacion2}>Tipo de sangre: A</Text>
				...
				<View style = {styles.cartaPaciente}>
					...
					>
						<View style = {styles.contenedorContenido}>
							<Text style = {styles.informacion}>Paciente: Daniel Carranza</Text>
							<Text style = {styles.informacion2}>Tipo de sangre: A</Text>
							<Text style = {styles.informacion}>Tipo de RH: Positivo</Text>
						</View>
					</TouchableHighlight>
